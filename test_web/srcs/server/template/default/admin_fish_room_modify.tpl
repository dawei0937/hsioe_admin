               ...
               <table class='table config-table'>
                              ...
                              <td>
                                <table class='table config-table' border='1'>
                                    <tr>
                                         ...
                                         <td>
                                             <input type="text" value="{{room_info['room_id']}}" readonly="" style='width:100%;float:left' id="room_id" name="room_id" class="form-control">
                                    ...
                                    <tr>
                                         ...
                                         <td>
                                             <input type="text" value="{{room_info['room_name']}}" style='width:100%;float:left' id="room_name" name="room_name" class="form-control">
                        ...
                        <tr>
                              <td class='table-title'>
                                   奖票生成配置<br/>
                                      <small>
                                          当出票保底公式成立，其归属者的 所获幸运票数 =（当局金币消耗 - 当局收益金币 - 金币保底数额）/金币价值，得出幸运票获取数。
                                      </small>
                              </td>
                              <td>
                                <table class='table config-table table1' border='1'>
