  ...
  */
  function initTable() {
    ...
    function responseFun(res){
        ...
        //实时刷
        $('.betTotalMoney').html(String.format("投注总额:<font color='#6600FF'>{0}</font>",totalMoney));

        if (parseInt(winLostTotal)>0){
            showStr = "输赢总额:<font color='red'>+{0}</font>";
            showWinStr = "输赢比:<font color='red'>{0}%</font>";
        }else{
            showStr = "输赢总额:<font color='green'>{0}</font>";
            showWinStr = "输赢比:<font color='green'>{0}%</font>";
        }
