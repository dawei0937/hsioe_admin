  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
            <form action="{{info['submitUrl']}}" id="dw-login-form" onsubmit="return false;" class="layui-form" method="post">
    ...
    <script src="{{info['STATIC_ADMIN_PATH']}}/js/ajax.js"></script>
    <script type="text/javascript">
        $('#dw-login-form').submit(function(){
              formAjax($(this).attr("action"), $(this).attr("method"), $(this).serialize(),'正在登录...');
        });
