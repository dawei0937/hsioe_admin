...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{info['STATIC_ADMIN_PATH']}}/css/sccl.css?{{RES_VERSION}}">
    <link rel="stylesheet" href="{{info['STATIC_ADMIN_PATH']}}/css/bootstrap.css?{{RES_VERSION}}">
    <link rel="stylesheet" type="text/css" href="{{info['STATIC_ADMIN_PATH']}}/skin/blue/skin.css?{{RES_VERSION}}" id="layout-skin"/>
    <link rel="stylesheet" href="{{info['STATIC_ADMIN_PATH']}}/js/layerMobile/layer.css?{{RES_VERSION}}">
  </head>
    ...
    <div class="layout-admin">
        ...
        <section class="layout-main">
            ...
            <div class="layout-main-body">
                <iframe class="body-iframe" name="iframe0" width="100%" height="100%" src="{{info['ADMIN_DEFAULT_PAGE']}}" frameborder="0" data-id="home.html" seamless></iframe>
            </div>
        </section>
        <div class="layout-footer">{{lang.COPY_RIGHT_TXT}}</div>
    </div>
    <script type="text/javascript" src="{{info['STATIC_ADMIN_PATH']}}/lib/jquery-1.9.0.min.js?{{RES_VERSION}}"></script>
