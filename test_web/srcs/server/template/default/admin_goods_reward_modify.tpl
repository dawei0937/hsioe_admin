                                    ...
                                    <tr>
                                         ...
                                         <td>
                                             %if reward['reward_type'] == '0':
                                                 <input type="radio"  id="reward_type" name="reward_type" checked="checked" value="0" /> 实物
                                                 <input type="radio"  id="reward_type" name="reward_type" value="1" /> 卡密
                                             %else:
                                                 <input type="radio"  id="reward_type" name="reward_type" value="0" /> 实物
                                                 <input type="radio"  id="reward_type" name="reward_type" checked="checked" value="1" /> 卡密
                                             %end
